...
#if defined(NDEBUG)
# error "Epsilon cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Epsilon Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s EPS additional fees, %d delta bytes\n",
