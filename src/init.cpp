 ...
 * between epsilond, and epsilon-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/epsilon-coin/epsilon>";
    const std::string URL_WEBSITE = "<https://epsilon.live>";
...
/** Sanity checks
 *  Ensure that Epsilon is running in a usable environment with all
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Make sure only a single Epsilon process is using the data directory.
