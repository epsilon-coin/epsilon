...
{
    const char* pszTimestamp = "03/12/2017 @ 10:18am";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetSpacing = 150;  // 150 sec
        ...
        genesis = CreateGenesisBlock(1489313885, 3665044702, 0x1d00ffff, 1, 100 * COIN);

        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000000017d39d6b4f72cd239e98bb3f28444d7ec9c437690b491cd03e4f34b7"));
        assert(genesis.hashMerkleRoot == uint256S("0x9d5073cd081a23e7a424e2c413487d750ce6c01b169d0551138431fcf1310a3b"));
	...
	vSeeds.push_back(CDNSSeedData("139.59.153.214", "139.59.153.214"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            1489313885, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1489313886, 2635542478, 0x1d00ffff, 1, 100 * COIN);

        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000000003ad7eeedead551239e2705694bd353a76489c48d88c58cf97cb14445"));
        assert(genesis.hashMerkleRoot == uint256S("0x9d5073cd081a23e7a424e2c413487d750ce6c01b169d0551138431fcf1310a3b"));
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1489313887, 1, 0x207fffff, 1, 100 * COIN);

        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x547f65b9037dd955df83b945b12c8802a3bd0467239a8f4bdaa5b3647d87a3a0"));
        assert(genesis.hashMerkleRoot == uint256S("0x9d5073cd081a23e7a424e2c413487d750ce6c01b169d0551138431fcf1310a3b"));
